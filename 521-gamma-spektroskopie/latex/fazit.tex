...
Es wurden mithilfe von Gammaspektroskopie die verwendeten NaI- und einem HPGe-Detektoren in ihren Pulsformen, Kanal-zu-Energie-Zusammenhängen, Energieauflösungen (über die Halbwertsbreiten) und Detektionseffizienzen charakterisiert. Dabei wurden als Proben mit bekannten Emissionslinien $\ce{^60Co}, \ce{^137Cs}$ und $\ce{^152Eu}$ verwendet. Anschließend wurde eine unbekannte Bodenprobe auf in der Umwelt vorkommende Radionuklide untersucht und die Photopeaks des Spektrums spezifischen Radionuklid-$\gamma$-Zerfällen zugeordnet.
