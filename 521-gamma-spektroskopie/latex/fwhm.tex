...
Die FWHM der angepassten Linien aus Tabelle \ref{tab:fwhm} werden nun mit Gl \eqref{eq:fwhm} und \eqref{eq:fwhme} berechnet. Die Ergebnisse sind in Tabelle \todo{refrence} zu finden. Man erkennt sofort, dass die Halbwertsbreite des HPGE Detektors um mehrere Größenordnungen kleiner ist, als die des NaI Detektors.
