...
\section{Auswertung}
Es soll zunächst das Lambert-Beersche-Gesetz überprüft werden, welches für den Transmittierten Strahlungsteil $T$, nach Materialdicke $d$, mit einem Absorbtionskoeffizienten $\mu$ den folgenden Zusammenhang aufstellt \todo{cite!!}
\begin{align}
