...
\section{Auswertung}
Es wird im Allgemeinen zwischen paralysierender und nicht paralysierender Totzeit unterschieden. Für die paralysierende Totzeit $\tau_p$ erwartet man zwischen gemessener Zählrate $m$ und tatsächlicher Zählrate $n$ den Zusammenhang \cite[776]{kolanoskiwermerdetektoren}
\begin{align}
	m = \frac{n}{1 - n \tau_p}
\end{align}
...
Speziell für GMZ kann ein Mischfall betrachtet werden \cite{gm_deadtime}
\todo{gleichung}

Die Messdaten (in Tabelle \todo{tabelle} zu finden) werden in \fig{deadtime} aufgetragen und 
\jafps{deadtime}{}{0.8}
