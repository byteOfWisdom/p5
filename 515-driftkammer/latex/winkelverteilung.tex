...
Hierzu wird der \textit{minuit2} minimizer mit der \textit{ROOT} Fit funktionalität genutzt \cite{root}. Es ergeben sich die Anpassungsergebnisse in Tabelle \ref{tab:fitres}, mit einem reduzierten $\chi^2_\text{red} = 4.2$ \cite{chi2}.
