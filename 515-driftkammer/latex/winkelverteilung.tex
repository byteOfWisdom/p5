...
Hierzu wird der \textit{minuit2} minimizer mit der \textit{ROOT} Fit funktionalität genutzt \cite{root}. Es ergeben sich die Anpassungsergebnisse in Tabelle \ref{tab:fitres}, mit einem reduzierten $\chi^2_\text{red} = 4.4$ \cite{chisquare}. Dies spricht dafür, dass die von uns gemessene Winkelverteilung sinnvoll ist, da sie gut mit den Erwartungen übereinstimmt.

\begin{table}[h]
\centering
\begin{tabular}{|c|c|c|c|} \hline
Parameter & $I_0$ & $\Theta_0$ & $a$\\ \hline
Wert & $\num{ 906(15)}$ & $\SI{0.1(2)}{\degree}$ & $\num{-149(7)}$ \\
\hline
\end{tabular}
...
\jafps{winkelverteilung}{Winkelverteilung der kosmischen Strahlung, mit Anpassungsfunktion nach Gl \eqref{eq:fitfunc}, $\chi^2_\text{red} = 4.4$}{0.75}
